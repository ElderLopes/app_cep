import 'package:app_cep/viacep/viacep_viewmodel.dart';
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                    "Logadouro: ${model.viacepModel.logradouro}"),
                                Text("${model.viacepModel.localidade}"
                                    "-"
                                    "${model.viacepModel.uf}"),
                              ],
                            )
                          ],
                        ),
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('CEP: ${model.listCep[index].cep}'),
                                    Text(
                                    ...
                                    Text(
                                        'Cidade: ${model.listCep[index].localidade}'),
                                    Text('Estado: ${model.listCep[index].uf}'),
                                  ],
                                ),
                              ),
                              const Spacer(),
                              TextButton(
                                onPressed: () async {
                                  await model.deleteCEP(
                                      model.listCep[index].objectId!);
                                },
